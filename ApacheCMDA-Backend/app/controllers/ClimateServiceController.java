...
@Named
@Singleton
public class ClimateServiceController extends Controller implements IController{
	...
	public Result addClimateService() {
		...
		try {
			...
			ClimateService savedClimateService = climateServiceRepository
					.save(climateService);
			StrategyContext strategyClimate = new StrategyContext(savedClimateService);
			...
			System.out.println(strategyClimate.strategyToString());
			return created(new Gson().toJson(strategyClimate.strategyGetId()));
...
//                .findByOrderByCreateTimeDesc();
	...
	public Result addServiceEntry() {
		...
		try {
			...
			StrategyContext strategyServiceEntry = new StrategyContext(savedServiceEntry);
			System.out.println("Service Entry saved: "
					+ strategyServiceEntry.strategyGetId());
			System.out.println(strategyServiceEntry.strategyToString());
