...
@Named
@Singleton
public class GroupUsersController extends Controller implements Store, IController{
    ...
    public Object response(Object g) {
        GroupUsers group = (GroupUsers)g;
        if (group == null) {
            System.out.println("group not created, expecting Json data");
            return (Object)Common.badRequestWrapper("group not created, expecting Json data");
        }
        return (Object)created(new Gson().toJson(group.getGroupUrl()));
    }
