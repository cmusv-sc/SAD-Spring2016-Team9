...
@Named
@Singleton
public class MailController extends Controller implements Store, IController {
    ...
    public Object response(Object m) {
        Mail mail = (Mail)m;
        if (mail == null) {
            return Common.badRequestWrapper("mail not sent, expecting Json data");
        } else if (mail.getFromUserMail() == null || mail.getToUserMail() == null) {
