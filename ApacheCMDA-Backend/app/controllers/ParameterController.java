...
@Named
@Singleton
public class ParameterController extends Controller implements IController {
    ...
    public Result addParameter() {
		...
		try {
			...
			StrategyContext strategyParameter = new StrategyContext(savedParameter);
			System.out.println("Parameter saved: " + savedParameter.getName());
			System.out.println(strategyParameter.strategyToString());
			return created(new Gson().toJson(strategyParameter.strategyGetId()));
