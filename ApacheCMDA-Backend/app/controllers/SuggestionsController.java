...
@Named
@Singleton
public class SuggestionsController extends Controller implements IController {
    ...
    public Result publishSuggestion() {
        ...
        StrategyContext strategySuggestions = new StrategyContext(suggestions);
        System.out.println(strategySuggestions.strategyToString());
        suggestionsRepository.save(suggestions);
        return created(new Gson().toJson(strategySuggestions.strategyGetId()));
    }
