...
@Named
@Singleton
public class TagController extends Controller implements IController {
    ...
    public Result createTag() {
        ...
        try {
            ...
            StrategyContext stragetyTag = new StrategyContext(tag);
            System.out.println("Tag saved: " + stragetyTag.strategyGetId());
            System.out.println(stragetyTag.strategyToString());
            return created(new Gson().toJson(stragetyTag.strategyGetId()));
