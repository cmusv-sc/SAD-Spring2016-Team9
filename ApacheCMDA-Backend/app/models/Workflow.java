...
@Entity
public class Workflow implements IStrategy {
	...
	public static class WorkFlowBuilder{
		...
		public WorkFlowBuilder buildwfTitle(String wfTitle) {
			this.wfTitle = wfTitle;
			return this;
		}

		public WorkFlowBuilder buildwfCategory(String wfCategory) {
			this.wfCategory = wfCategory;
			return this;
		}


		public WorkFlowBuilder buildwfCode(String wfCode) {
			this.wfCode = wfCode;
			return this;
		}

		public WorkFlowBuilder buildwfDesc(String wfDesc) {
			this.wfDesc = wfDesc;
			return this;
		}


		public WorkFlowBuilder buildwfImg(String wfImg) {
			this.wfImg = wfImg;
			return this;
		}
		...
		private String wfTitle = "Initial";
		private String wfCategory = "Initial";
		private String wfCode = "Initial";
		private String wfDesc = "Initial";
		private String wfImg = "Initial";
		private String wfVisibility = "Initial";
		private String status = "Initial";
		private long   viewCount = 1L;
		private long   groupId = 1L;
		private boolean edit = false;
		private String wfUrl = "Initial";
		private String wfInput ="Initial";
		private String wfOutput = "Initial";
		private Date wfDate = new Date();
	}
