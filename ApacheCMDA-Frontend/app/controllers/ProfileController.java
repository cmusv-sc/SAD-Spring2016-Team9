 ...
 */
public class ProfileController extends Controller implements IController {
    ...
    public static Result profile(Long id) {
        ...
        JsonNode response = get.execute(Constants.NEW_BACKEND + "users/getprofile/" + id.toString() + "/json", null);
        System.out.println("nan: response=" + response.toString());
